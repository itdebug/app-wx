...
import cn.itdebug.wx.common.bean.material.*;
...
public interface WxMpMaterialService {
     ...
     * @return the wx media upload result
     * @throws WxErrorException the wx error exception
     * @see #mediaUpload(String, File) #mediaUpload(java.lang.String, java.io.File)#mediaUpload(java.lang.String, java.io.File)
     */
